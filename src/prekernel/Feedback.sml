...
val emit_ERR     = ref @{position} true
val emit_MESG    = ref @{position} true
val emit_WARNING = ref @{position} true
val WARNINGs_as_ERRs = ref @{position} false

fun out strm s = (TextIO.output(strm, s); TextIO.flushOut strm)

val ERR_outstream     = ref @{position} (out TextIO.stdErr)
val MESG_outstream    = ref @{position} (out TextIO.stdOut)
val WARNING_outstream = ref @{position} (out TextIO.stdOut)
...
val ERR_to_string     = ref @{position} format_ERR
val MESG_to_string    = ref @{position} format_MESG
val WARNING_to_string = ref @{position} format_WARNING
...
val trace_map =
    ref @{position} (Binarymap.mkDict String.compare : (string,TI)Binarymap.dict)
